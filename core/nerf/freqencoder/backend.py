...
if os.path.exists(os.path.join(build_directory, "_freqencoder.pyd")):
    try:
        os.remove(os.path.join(build_directory, "_freqencoder.pyd"))
    except:
        pass
...
try:
    ...
    print(f"Failed to build _freqencoder extension: {str(e)}")
    raise
